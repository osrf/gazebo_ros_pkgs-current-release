## gazebo_ros_pkgs (groovy) - 2.4.2-1

User `jrivero@quartz` released the packages in the `gazebo_ros_pkgs` repository into the `groovy` distro by running `/usr/bin/bloom-release --track groovy --ros-distro groovy gazebo_ros_pkgs` on `Wed, 02 Apr 2014 00:53:44 -0000`
...
## gazebo_ros_pkgs-current (hydro) - 2.4.2-1

User `jrivero@quartz` released the packages in the `gazebo_ros_pkgs-current` repository into the `hydro` distro by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo_ros_pkgs-current --edit` on `Wed, 02 Apr 2014 00:50:49 -0000`
...
## gazebo_ros_pkgs-current - 2.4.1-3

User `yos@gem` released the packages in the `gazebo_ros_pkgs-current` repository by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo_ros_pkgs-current --edit` on `Fri, 31 Jan 2014 01:11:27 -0000`
...
## gazebo_ros_pkgs-current - 2.4.1-2

User `yos@gem` released the packages in the `gazebo_ros_pkgs-current` repository by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo_ros_pkgs-current --edit` on `Thu, 30 Jan 2014 23:12:30 -0000`
...
## gazebo_ros_pkgs-current - 2.4.1-1

User `jrivero@quartz` released the packages in the `gazebo_ros_pkgs-current` repository by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo_ros_pkgs-current --edit` on `Wed, 20 Nov 2013 12:28:37 -0000`
...
User `jrivero@quartz` released the packages in the `gazebo_ros_pkgs-current` repository by running `/usr/bin/bloom-release --track groovy --ros-distro groovy gazebo_ros_pkgs-current --edit` on `Wed, 20 Nov 2013 12:20:32 -0000`
